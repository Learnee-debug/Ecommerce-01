                        ...
                        <form className="space-y-6">
                            <div>
                                ...
                                <div className="mt-1 ">
                                    ...
                                    autoComplete="passeord" required value={password}
                                    onChange={(e)=>setEmail(e.target.value)}
                                    className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 foucs:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"/>
                                </div>
                            ...
                            <div className="flex justify-between items-center">
                                <div className="flex items-center">
                                    ...
                                    id="remember-me"
                                    className="h-4 w-4 text-blue-600 focus:ring-gray-300 rounded"/>
                                    <label htmlFor ="remember-me " className="ml-2 block text-sm text-gray-900">REMEMBER ME</label>
                                
                                </div>
                                <div className="text-sm">
                                    <a href=".forgot-password"
                                    className="font-medium text-blue-600 hover:text-blue-500">Forgot Password
                            ...
                            <div>
                                <button type ="submit" className="realtive w-full h-6 flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                                    Submit
                                </button>
                            </div>
